        ...
        canvas.onclick = function (e) {
            ...
            if (_marker !== null) {
                ...
                if (that.markMode !== 'text') {
                    ...
                    _marker.appendChild(_delBtn);
                    _marker.appendChild(__editableTextAnnotate);
                    _marker.style.left = mouse.x + 'px';
                    _marker.style.top = mouse.y + 'px';
                    canvas.appendChild(_marker);
                }
...
const mouseOut = (event) => {
    if (!paths.includes(event.target))
...
const deleteTarget = (event) => {
    ...
    const newPaths = paths === null || paths === void 0 ? void 0 : paths.filter((item) => item !== target);
    paths = [];
    paths.push(newPaths.flat());
    drawPaths();
};
const addDeleteBtn = (event) => {
...
const init = () => {
    if (typeof document !== 'undefined') {
        window === null || window === void 0 ? void 0 : window.addEventListener('mousemove', mouseMove);
