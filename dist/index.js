0482 9.37699 18.1891 10.5016C19.33 11.6263 19.9786 13.1574 19.9927 14.7593C19.985 15.8697 19.6693 16.9562 19.0808 17.8978C18.4923 18.8394 17.6541 19.5992 16.6593 20.0927C16.4949 20.1758 16.3702 20.3208 16.3127 20.4958C16.2842 20.5825 16.2731 20.6739 16.28 20.7649C16.2868 20.8559 16.3115 20.9446 16.3527 21.026C16.3938 21.1074 16.4506 21.1799 16.5198 21.2394C16.589 21.2989 16.6692 21.3442 16.7558 21.3726C16.9309 21.4302 17.1216 21.4158 17.286 21.3327C18.7641 20.5868 19.9463 19.3627 20.6403 17.8595C21.3343 16.3564 21.4992 14.6626 21.1082 13.0538C20.7172 11.445 19.7933 10.0159 18.4868 8.99891C17.1804 7.98193 15.5682 7.43696 13.9127 7.45268V7.42601Z" fill="black"/>
  </svg>
  `
};
...
class Snipping {
    constructor(config) {
        ...
        this.__changeActiveTool = (el, inActiveEl) => {
            el.classList.add('__snipping_button_active');
            inActiveEl === null || inActiveEl === void 0 ? void 0 : inActiveEl.map((el) => {
    ...
    <div class="__annotateTools">
        ...
        ${getIcon('undo')}
        <sub class="__undoElCounts">${((_a = this.annotateLists) === null || _a === void 0 ? void 0 : _a.length) !== 0 ? (_b = this.annotateLists) === null || _b === void 0 ? void 0 : _b.length : ''}</sub>
        </button>
    ...
    _initDraw(canvas) {
        ...
        let _marker = null;
        let _textAnnotateEl = null;
        let _delBtn = null;
        let __editableTextAnnotate = null;
        ...
        canvas.onclick = function (e) {
            ...
            if ((e === null || e === void 0 ? void 0 : e.target).className === '__annotateTextTool')
                return null;
            if ((e === null || e === void 0 ? void 0 : e.target).className === '__annotateTextToolInput')
                return null;
            if (_marker !== null) {
                _marker = null;
                canvas.style.cursor = 'default';
            }
            else if (((_a = e === null || e === void 0 ? void 0 : e.target) === null || _a === void 0 ? void 0 : _a.name) === 'delMarker') {
                _marker = null;
                canvas.style.cursor = 'default';
            }
            else {
            ...
            `,
                    ...
                    __editableTextAnnotate === null || __editableTextAnnotate === void 0 ? void 0 : __editableTextAnnotate.setAttribute('contenteditable', 'true');
                    _textAnnotateEl.appendChild(_delBtn);
                    _textAnnotateEl.appendChild(__editableTextAnnotate);
                    _textAnnotateEl.style.left = mouse.initialX + 'px';
                    _textAnnotateEl.style.top = mouse.initialY + 'px';
                    canvas.appendChild(_textAnnotateEl);
    ...
    _prepareDom() {
        ...
        const _snapedImg = _createElement({
            Tag: 'img',
            id: 'screenshot'
        });
        /** rendering elements */
