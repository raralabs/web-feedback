...
class Snipping {
  constructor(config) {
    ...
    this.__changeActiveTool = (el, inActiveEl) => {
      ...
      inActiveEl === null || inActiveEl === void 0
        ? void 0
        : inActiveEl.map((el) => {
  ...
  _initDraw(canvas) {
    ...
    canvas.onclick = function (e) {
      ...
      if ((e === null || e === void 0 ? void 0 : e.target).className === '__annotateTextTool') return null;
      if ((e === null || e === void 0 ? void 0 : e.target).className === '__annotateTextToolInput') return null;
      if (_marker !== null) {
        _marker = null;
